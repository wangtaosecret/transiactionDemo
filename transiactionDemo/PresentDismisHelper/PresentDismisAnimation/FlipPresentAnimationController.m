...
//		[cell convertRect:cell.bounds toView:self.view]
		_originalFrame = [_destinationView convertRect:_destinationView.bounds toView:_convertView];
...
- (instancetype)initWithOriginalView:(UIView *)destinationView convertView:(UIView *)convertFrameView interactionController:(PresentInterationController *)viewController withType:(PresentAnimationControllerType)type{
	_convertView = convertFrameView;
	return [self initWithOriginalView:destinationView interactionController:viewController withType:type];
}
